<div class="modal fade bd-example-modal-xl" id="approver_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-head-fixed text-nowrap table-hover text-center" id="modal_table">
                    ...
                    <tbody id="approver_modal_table"> </tbody>
                </table>
