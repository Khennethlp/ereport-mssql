<aside class="main-sidebar  collapsed elevation-4" id="sidebar">
  <!-- Brand Logo -->
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/e-report/pages/checker/index.php") {?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/e-report/pages/checker/history.php") {?>
