...
if ($method == 'load_t_t2') {
    ...
    $revisions_sql = "SELECT a.serial_no, a.file_name AS file_name, b.revised_by AS revised_by,b.serial_no, b.revision_date AS revision_date FROM t_upload_file a RIGHT JOIN (SELECT serial_no, revision_date, revised_by FROM file_revisions) b ON a.serial_no = b.serial_no WHERE b.serial_no = '$serial_no' ORDER BY b.revision_date DESC";
    $stmt = $conn->prepare($revisions_sql);
    $stmt->execute();
    $c = 0;
